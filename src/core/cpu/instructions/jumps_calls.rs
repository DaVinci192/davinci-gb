...
pub fn op_jp_cc_n16(ctx: &mut CpuExec, cc: bool) {
    match ctx.cpu.step {
        1 => {
            op_read_n8(ctx);
            ctx.cpu.temp16 = ctx.cpu.temp as u16;
...
pub fn op_jp_nz_n16(ctx: &mut CpuExec) { op_jp_cc_n16(ctx, !ctx.cpu.f.z); }
pub fn op_jp_z_n16(ctx: &mut CpuExec) { op_jp_cc_n16(ctx, ctx.cpu.f.z); }
pub fn op_jp_nc_n16(ctx: &mut CpuExec) { op_jp_cc_n16(ctx, !ctx.cpu.f.c); }
pub fn op_jp_c_n16(ctx: &mut CpuExec) { op_jp_cc_n16(ctx, ctx.cpu.f.c); }
...
pub fn op_jr_cc_e8(ctx: &mut CpuExec, cc: bool) {
    match ctx.cpu.step {
        1 => {
            op_read_n8(ctx);
        },
...
pub fn op_jr_nz_e8(ctx: &mut CpuExec) { op_jr_cc_e8(ctx, !ctx.cpu.f.z); }
pub fn op_jr_z_e8(ctx: &mut CpuExec) { op_jr_cc_e8(ctx, ctx.cpu.f.z); }
pub fn op_jr_nc_e8(ctx: &mut CpuExec) { op_jr_cc_e8(ctx, !ctx.cpu.f.c); }
pub fn op_jr_c_e8(ctx: &mut CpuExec) { op_jr_cc_e8(ctx, ctx.cpu.f.c); }
...
pub fn op_call_cc_n16(ctx: &mut CpuExec, cc: bool) {
    match ctx.cpu.step {
        1 => {
            op_read_n8(ctx);
            ctx.cpu.temp16 = ctx.cpu.temp as u16;
...
pub fn op_call_nz_n16(ctx: &mut CpuExec) { op_call_cc_n16(ctx, !ctx.cpu.f.z); }
pub fn op_call_z_n16(ctx: &mut CpuExec) { op_call_cc_n16(ctx, ctx.cpu.f.z); }
pub fn op_call_nc_n16(ctx: &mut CpuExec) { op_call_cc_n16(ctx, !ctx.cpu.f.c); }
pub fn op_call_c_n16(ctx: &mut CpuExec) { op_call_cc_n16(ctx, ctx.cpu.f.c); }
...
pub fn op_ret_cc(ctx: &mut CpuExec, cc: bool) {
    match ctx.cpu.step {
        1 => {
            // cc check
...
pub fn op_ret_nz(ctx: &mut CpuExec) { op_ret_cc(ctx, !ctx.cpu.f.z); }
pub fn op_ret_z(ctx: &mut CpuExec) { op_ret_cc(ctx, ctx.cpu.f.z); }
pub fn op_ret_nc(ctx: &mut CpuExec) { op_ret_cc(ctx, !ctx.cpu.f.c); }
pub fn op_ret_c(ctx: &mut CpuExec) { op_ret_cc(ctx, ctx.cpu.f.c); }
...
pub fn op_isr_vec(ctx: &mut CpuExec, vec: u16, bit: u8) {
    match ctx.cpu.step {
        1 => {
            // rewind overlapped fetch
            ctx.cpu.pc = ctx.cpu.pc.wrapping_sub(1);

            ctx.cpu.ime = false;
            ctx.bus.set_iflag(ctx.bus.iflag() & !(1 << bit));
